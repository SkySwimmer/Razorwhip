...
namespace SentinelSelfExtractingInstaller
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            Task.Run(() =>
            {
                ...
                // Seek to header
                byte[] magic = Encoding.UTF8.GetBytes("SENTINEL!LAUNCHER");
                ...
                proc.StartInfo.Arguments = "-cp " + cp + " org.asf.razorwhip.sentinel.launcher.updater.LauncherUpdaterMain " + Program.Arguments;
                proc.Start();
